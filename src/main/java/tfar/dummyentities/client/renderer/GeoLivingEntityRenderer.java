...
public abstract class GeoLivingEntityRenderer <T extends EntityLivingBase & IAnimatable> extends RenderLivingBase<T> implements IGeoRenderer<T> {
    protected final AnimatedGeoModel<T> modelProvider;
    protected final List<GeoLayerRenderer<T>> layerRenderers = Lists.newArrayList();

    public GeoLivingEntityRenderer(RenderManager renderManager, AnimatedGeoModel<T> modelProvider) {
    ...
    protected void renderLeash(EntityLiving entityLivingIn, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        if (entity != null) {
            ...
            double d9 = this.interpolateValue(entityLivingIn.prevRenderYawOffset, entityLivingIn.renderYawOffset, partialTicks) * 0.01745329238474369 + 1.5707963267948966;
